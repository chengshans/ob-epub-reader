...
- [ ] **行距 / 段距 / 字距** — 阅读设置中可调排版疏密
- [ ] **全文搜索** — 当前书内搜索并跳转到命中位置
- [ ] **书签** — 独立于高亮的位置书签列表
- [ ] **更多开源字体预设** — 在授权允许下扩充可下载字体
- [ ] **阅读统计** — 书架或独立视图展示时长、进度趋势
- [ ] **固定版式 EPUB** — 改善 fixed-layout 书籍的适配与提示
- [ ] **摘录导出增强** — 按书/按时间段导出、更多外部格式
- [ ] **冲突与备份提示** — 摘录文件被外部修改时的更稳妥合并策略
- [ ] **移动端探索** — 评估 Obsidian 移动端可行性（当前仅桌面）
