...
- **正文字体** — 黑体/宋体/楷体/仿宋/圆体、思源、霞鹜文楷等预设；可下载字体缺失时自动缓存并带进度提示
...
- **正文字体** — 系统黑体/宋体/楷体等，以及思源、霞鹜文楷（可下载缓存）
...
| 默认阅读模式 | 分页 / 滚动 | 滚动 |
| 默认字体大小 | 内容区字号（px） | 16 |
| 正文字体 | 跟随 Obsidian / 黑体 / 宋体 / 楷体 / 仿宋 / 圆体 / 思源 / 霞鹜等 | 跟随 Obsidian |
| 两侧空白 | 阅读正文左右留白（px） | 12 |
